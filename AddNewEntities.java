...
public class AddNewEntities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		pw.print("<form method='post' action='AddNewEntities' enctype='multipart/form-data'>"
		...
		pw.print("</optgroup>"
				...
				+ "<input type='text' name='discount' placeholder='Discount $' required='required'>"
